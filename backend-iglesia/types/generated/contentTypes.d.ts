...
export interface ApiContactoContacto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mensaje: Schema.Attribute.Blocks & Schema.Attribute.Required;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publicar_facebook: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<false>;
    publicar_instagram: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    publicar_tiktok: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    publicar_whatsapp: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiInicioInicio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Imagenes: Schema.Attribute.Component<'images.slider', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::inicio.inicio'
    > &
      Schema.Attribute.Private;
    Pagina: Schema.Attribute.Enumeration<
      [
        'Inicio',
        'Somos Familia',
        'Vida de Iglesia',
...
export interface ApiInteraccionInteraccion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    Tipo: Schema.Attribute.Enumeration<['Peticion', 'Testimonio']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMultimediaMultimedia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Tipo: Schema.Attribute.Enumeration<
      ['Youtube', 'RightMedia', 'Video', 'Audio']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
